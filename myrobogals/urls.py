...
urlpatterns = [
    ...
    url(r'^chpass/$', auth_views.password_change,
        {'template_name': 'password_change_form.html', 'post_change_redirect': '/profile'}),
    url(r'^forgotpass/done/$', auth_views.password_reset_done, {'template_name': 'password_reset_done.html'},
        name='password_reset_done'),
    url(r'^forgotpass/confirm/(?P<uidb64>[0-9A-Za-z_\-]+)/(?P<token>.+)/$', auth_views.password_reset_confirm,
        {'template_name': 'password_reset_confirm.html'}),
    url(r'^forgotpass/complete/$', auth_views.password_reset_complete,
        {'template_name': 'password_reset_complete.html'}, name='password_reset_complete'),
    url(r'^forgotpass/$', auth_views.password_reset,
    ...
    url(r'^join/(?P<chapterurl>.+)/token=(?P<token>.+)/', profile_user.joinfrominvite),
    ...
    # url(r'^chapters/(?P<chapterurl>.+)/edit/users/invite/invitesent/$', profile_chapter.invitesent),
    # url(r'^chapters/(?P<chapterurl>.+)/edit/users/invite/inviteerror/$', profile_chapter.inviteerror),
    url(r'^chapters/(?P<chapterurl>.+)/edit/users/invite/$', profile_chapter.inviteuser),
    url(r'^chapters/(?P<chapterurl>.+)/edit/users/$', profile_chapter.editusers, name='chapters_edit_users'),
